...
func assertEqual(t *testing.T, expectedResult interface{}, actualResult interface{}) {
...
func TestAdditionWithMultipleMissingExchangeRates(t *testing.T) {
	...
	assertNil(t, value)
	assertEqual(t, "Missing exchange rate(s):[USD->Kalganid,EUR->Kalganid,KRW->Kalganid,]", actualError.Error())
}
